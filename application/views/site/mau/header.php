...
<div class="top">
      ...
      <div id="logo"><!-- the logo -->
           <a title="shop thời trang" href="<?php echo base_url('home')?>">
	           <img alt="shop thời trang" src="<?php echo public_url()?>/site/images/logo.png" style="width:250px">
	       </a>
       </div>
       <!-- End logo -->
    ...
    <div class="clear"></div><!-- clear float --> 
           ...
           <ul class="menu_top">
                ...
                <li class=""><a href="<?php echo base_url('gioithieu');?>">Giới thiệu</a></li><!--class="active index-li"-->
                ...
                <li class=""><a href="<?php echo base_url('admin/login');?>" target="_blank">Quản trị admin</a></li>
