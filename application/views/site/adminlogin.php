...
<body id="login_bg">
	...
	<div id="login">
		<aside>
			<figure>
                            <a href="<?php echo base_url();?>"><img src="<?php echo public_url();?>/site/img/logo_sticky.png" width="155" height="36" data-retina="true" alt="" class="logo_sticky"><strong>Admin</strong></a>
			</figure>
